...
const translations = {
    vi: {
        ...
        'common.scanningQR': 'Đang quét QR code...',
        'common.or': 'HOẶC',
        ...
        'chat.qrExpired': 'QR code đã hết hạn',
        'chat.invalidQRToken': 'Token QR không hợp lệ',
    ...
    en: {
        ...
        'common.scanningQR': 'Scanning QR code...',
        'common.or': 'OR',
        ...
        'chat.qrExpired': 'QR code expired',
        'chat.invalidQRToken': 'Invalid QR token',
    ...
    zh: {
        ...
        'chat.qrExpired': '二维码已过期',
        'chat.invalidQRToken': '无效的二维码令牌',
